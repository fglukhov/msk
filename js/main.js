...
$(document).ready(function() {
	...
	$(".home-serv-tmb").on("mouseover", function () {

		$(".services-tint").addClass("active");

		var curIndex = $(this).closest(".col").prevAll(".col").length;

		$(".home-serv-tmb").removeClass("active");

		$(this).addClass("active");

		$(".services-slider .slide").removeClass("active");

		$(".services-slider .slide").filter(function () {
		...
		$(".services-tint").removeClass("active");
